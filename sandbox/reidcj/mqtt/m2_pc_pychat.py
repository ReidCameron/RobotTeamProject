...
Authors: David Fisher and Cameron Reid.
...
def main():
    ...
    my_name = "Cam"  # Used to set the topic that you are *subscribed to* listen to
    team_member_name = "TJ"  # Used to set the topic that you will *publish to*
